...
output_file_path = os.path.join(output_directory, "q2_time_result")
log_file_path = os.path.join(log_directory, "q2_time_log.txt")
...
def q2_time(file_path: str) -> List[Tuple[str, int]]:
    """
    Esta función calcula los 10 emojis más usados y su respectivo conteo.
    ...
    try:
        ...
        log("Inicio de la ejecución de q2_time")
        ...
        log(f"Error durante la ejecución de q2_time: {e}")
        print(f"Error durante la ejecución de q2_time: {e}")
