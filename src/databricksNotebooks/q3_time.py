...
output_file_path = os.path.join(output_directory, "q3_time_result")
log_file_path = os.path.join(log_directory, "q3_time_log.txt")
...
def q3_time(file_path: str) -> List[Tuple[str, int]]:
    """
    Esta función calcula los 10 usuarios más influyentes en función del conteo de las menciones.
    ...
    try:
        ...
        log("Inicio de la ejecución de q3_time")
        ...
        log(f"Error durante la ejecución de q3_time: {e}")
        print(f"Error durante la ejecución de q3_time: {e}")
